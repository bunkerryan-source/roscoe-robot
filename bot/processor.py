    ...
    *,
    ...
    if media_type == "voice":
        ...
        try:
            ...
            # Surface the failure in the payload so downstream code can detect
            # it instead of silently classifying an empty payload (which causes
            # the classifier to hallucinate a summary from nothing).
